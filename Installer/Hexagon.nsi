...
!define INSTALLER_NAME "C:\Program Files (x86)\NSIS\Script Generator\Output\Hexagon\setup.exe"
...
InstallDir "$PROGRAMFILES\Coolcord\Hexagon"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Coolcord\Hexagon"
...
CreateDirectory "$SMPROGRAMS\Coolcord\Hexagon"
CreateShortCut "$SMPROGRAMS\Coolcord\Hexagon\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Coolcord\Hexagon\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
Delete "$INSTDIR\Config\Hexagon.cfg"
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Coolcord\Hexagon\${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Coolcord\Hexagon\${APP_NAME} Website.lnk"
!endif
RmDir "$SMPROGRAMS\Coolcord\Hexagon"
!endif
